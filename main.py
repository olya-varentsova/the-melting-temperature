...
def check_on_correct_input(nukleotid1, nukleotid2, Ca, Cb):
    k = 0
    k1 = len(nukleotid1)
    k2 = len(nukleotid2)
    if Ca <= 0 or Cb < 0:
...
def main():
    ...
    check_on_correct_input(args.seq1, args.seq2, args.Ca, args.Cb)
    temp = MeltingTemp(args.seq1, args.seq2, args.Ca, args.Cb)
